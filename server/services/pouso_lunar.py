...
def curvas_de_pouso_suave(data: VelocidadesResource) -> tuple:
    ...
    plt.figure(1)
    plt.plot(v0, y, "red", label="vel inicial vf - 0")
    plt.show()
...
# dados = VelocidadesResource(massa=1.1, gravidade=1.8, intensidade=3.6, angulacao=0, altura=18, velocidade_inicial=-10)

# curvas_velocidade(dados)

# curvas_de_pouso_suave(dados)
